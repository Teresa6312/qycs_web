    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.CharField(default='', max_length=16, verbose_name='License Number')),
                ('license_type', models.CharField(default='', max_length=16, verbose_name='License Type')),
                ('store', models.BooleanField(default=True, verbose_name='Store')),
                ('status', models.BooleanField(default=False, verbose_name='Avaliable')),
                ('image', models.ImageField(blank='True', upload_to='collector_image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(blank=True, default='', max_length=16, verbose_name='Collection Point Name')),
                ('last_name', models.CharField(blank=True, default='', max_length=16, verbose_name='Collection Point Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_value', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Item Value')),
                ('currency', models.CharField(default='', max_length=16, verbose_name='Currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='', max_length=64, verbose_name='Email Address')),
                ...
                ('account_id', models.CharField(blank=True, default='', max_length=32, verbose_name='Account Id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank='True', upload_to='package_snapshot')),
            ],
        ),
        migrations.CreateModel(
            name='ParentPackage',
            fields=[
                ...
                ('tracking_num', models.CharField(blank=True, default='', max_length=30, verbose_name='Tracking Number')),
                ('carrier', models.CharField(blank=True, default='', max_length=30, verbose_name='Carrier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_id', models.CharField(default='', max_length=20, unique=True, verbose_name='Payment Confirmation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Created on')),
                ('package_type', models.CharField(choices=[('Food', 'food'), ('Regular', 'regular'), ('Luxury', 'luxury'), ('Mix', 'mix')], default='', max_length=16, verbose_name='Package Type')),
                ('request_ship_date', models.DateField(blank=True, null=True, verbose_name='Requested to Ship on')),
                ('memo', models.TextField(blank=True, default='', verbose_name='Memo')),
                ('cust_tracking_num', models.CharField(blank=True, default='', max_length=30, verbose_name='Customer Tracking Number')),
                ('cust_carrier', models.CharField(blank=True, default='', max_length=20, verbose_name='Customer Carrier')),
                ('low_volume_request', models.BooleanField(default=True, verbose_name='Low Volume Request')),
                ...
                ('currency', models.CharField(blank=True, default='', max_length=20, verbose_name='Currency')),
        ...
        migrations.AlterField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Address', verbose_name='Default Mailing Address'),
        ),
        migrations.AlterField(
            model_name='userprofile',
            name='user',
        ...
        migrations.AddField(
            model_name='card',
            name='address',
            field=models.OneToOneField(default='', on_delete=django.db.models.deletion.DO_NOTHING, to='main.Address', verbose_name='Address'),
        ),
        migrations.AddField(
            model_name='card',
            name='user',
