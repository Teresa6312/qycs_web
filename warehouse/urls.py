...
urlpatterns = [
    ...
    path('co-shipping-packages/not-ready', login_required(list_views.NotReadyCoPackages.as_view()), name='not_ready_copackages'),
    ...
    path('co-shipping-packages/ready', login_required(list_views.ReadyCoPackages.as_view()), name='ready_copackages'),
    path('direct-shipping-packages/ready', login_required(list_views.ReadyDirectPackages.as_view()), name='ready_direct_packages'),
    path('co-shipping-packages/shipped', login_required(list_views.ShippedCoPackages.as_view()), name='shipped_copackages'),
